    ...
    <div class="row">
        ...
        <div class="col-8 edit-game-table">
            <div class="rent-infor">
                ...
                <a href="${pageContext.request.contextPath}/rentOutListPage.jsp?id=<%= product.getProductId() %>" class="rent-out-list" >
                     Rent Out List
                </a>
            </div>
            ...
            <div class="edit-game-img">
                ...
                <div class="upload-box" id="uploadBox">
                    ...
                    <img id="mainPreviewImage" class="preview" src="#" alt="Preview" style="display: none;"/>
                    <input type="file" id="mainFileInput" accept="image/*" style="display: none;">
<%--                    <label for="mainFileInput" style="cursor: pointer;">Choose Image</label>--%>
                </div>
            </div>
